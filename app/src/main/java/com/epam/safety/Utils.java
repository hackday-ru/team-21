...
/**
 * Created by dbychkov on 17.04.16.
 */
public class Utils {

    public static EaseType getEaseType(int p) {
    ...
    public static ShowType getShowType(int p) {
    ...
    public static HideType getHideType(int p) {
